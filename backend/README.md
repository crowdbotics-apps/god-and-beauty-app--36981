...
## Project Structure
    ...
    ├── god_and_beauty_app__36981  # Django project configurations
...
1. Clone this repo and `cd god_and_beauty_app__36981`
...
2. Clone this repo and `cd god_and_beauty_app__36981`
